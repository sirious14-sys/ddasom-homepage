...
<div class="wrap">
  ...
  <div class="hero">
    ...
    <p>__REGION__ 아파트·주택·상가 어디든 무료 방문 실측부터 맞춤 제작·설치까지. 창에 직접 원단을 대보고 색을 고른 뒤 시공하니 실패가 없습니다.</p>
    <div class="mgr">
  ...
  <p class="body">커튼·블라인드는 매장을 돌며 비교하기가 쉽지 않습니다. 따솜커튼블라인드는 <b>__REGION__ 전지역 출장 전문</b>으로, 방문 실측 → 원단·색 상담 → 맞춤 제작 → 설치까지 한 번에 끝냅니다.</p>
  <p class="body">별도 매장을 방문하실 필요 없이, __REGION__ 담당 <b>__MGR__(__TEL__)</b>이 직접 찾아가 창 사이즈를 재고 어울리는 제품을 제안합니다. 실측과 견적은 <b>무료</b>입니다.</p>
...
__CARDS__
  ...
  <div class="faq">
    <details open><summary>__REGION__도 출장 시공되나요?</summary><p>네, __REGION__ 전지역에 출장 시공합니다. __REGION__ 담당 __MGR__(__TEL__)이 직접 방문합니다.</p></details>
    <details><summary>실측·견적 비용이 드나요?</summary><p>__REGION__ 지역 방문 실측과 견적은 무료입니다. 창에 제품을 대보며 상담한 뒤 견적을 드립니다.</p></details>
    <details><summary>어떤 제품까지 시공하나요?</summary><p>속커튼·암막커튼·콤비블라인드·롤스크린·우드블라인드·전동 블라인드까지 맞춤 제작·시공합니다.</p></details>
    <details><summary>상담은 어떻게 하나요?</summary><p>전화나 문자로 __MGR__(__TEL__)에게 연락하시거나, <a href="../#apply" style="color:var(--accent2);font-weight:700">실측 신청 폼</a>에 성함·연락처·지역을 남기시면 연락드립니다.</p></details>
  </div>

  <div class="cta-final">
    <h2>__REGION__ 커튼·블라인드, 무료로 상담받으세요</h2>
    <p>창 사진만 있어도 대략 견적 안내가 가능합니다. __REGION__ 담당 __MGR__이 도와드립니다.</p>
